	...
	time.sleep(0.01) 
        ...
        ############################################################################################
                ...
                if event.key == 'RT':
                        ...
                        consigne_throttle_av = ((consigne_throttle*80/254)/20)
        ...
        ############################################################################################
                ...
                if event.key == 'Y1':
                        ...
                        consigne_pitch_av = ((consigne_throttle*80/254 + consigne_pitch*20/32767 + 1)/20)
                        consigne_pitch_ar = ((consigne_throttle*80/254 - consigne_pitch*20/32767)/20)
        ...
        ############################################################################################
                ...
                if event.key == 'X2':
                        ...
                        consigne_roll_av = ((consigne_throttle*80/254 + consigne_roll*20/32767 + 1)/20)
                        consigne_roll_ar = ((consigne_throttle*80/254 - consigne_roll*20/32767)/20)
        ...
        ############################################################################################
                ...
                if event.key == 'X1':
                        ...
                        consigne_yaw_av = ((consigne_throttle*80/254 + consigne_yaw*20/32767 + 1)/20)
                        consigne_yaw_ar = ((consigne_throttle*80/254 - consigne_yaw*20/32767)/20)
